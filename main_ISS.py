...
duration = convert.convertToSeconds(years=0, months=0, days=0, hours=0, minutes=93, seconds=0)
...
sat1 = satellite.Satellite("ISS", sat1_stateInit, sat1_omega, sat1_area, sat1_mass, sat1_solar_array_area, 'Purp')
